...
When using Tailscale, you can grant users specific roles for applications using [Tailscale's capabilities feature](https://tailscale.com/kb/1537/grants-app-capabilities). Add the `sierrasoftworks.com/cap/tailon` capability to your Tailscale ACL policy:
  ...
  "grants": [
    {
      ...
      "app": {
        "sierrasoftworks.com/cap/tailon": [
          {
            "role": "operator",
